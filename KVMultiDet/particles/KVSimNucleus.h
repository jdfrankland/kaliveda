...
public:
   ...
   KVSimNucleus(AtomicNumber z, MassNumber a = 0, KineticEnergy ekin = 0) : KVNucleus(z, a, ekin) {}
   KVSimNucleus(AtomicNumber z, KineticEnergy t, Direction d) : KVNucleus(z, t, d) {}
   KVSimNucleus(AtomicNumber z, MassNumber a, Momentum p) : KVNucleus(z, a, p) {}
